...
import { ArrowLeft, Clock, Download, Filter, Sun, Moon, FilterX, Zap } from 'lucide-react';
import { useThemeHandler } from '@/hooks/useThemeHandler';
import { useToast } from '@/hooks/use-toast';

interface QueueNavbarProps {
  timeRange: TimeRange;
...
export const QueueNavbar: React.FC<QueueNavbarProps> = ({
  timeRange,
  onTimeRangeChange,
  filters,
  onFiltersChange,
          ...
          <div className="bg-card/80 backdrop-blur-xl border border-border/50 rounded-2xl shadow-lg shadow-black/5 px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h2 className="text-lg font-semibold">Message Queue Monitoring</h2>
                </div>
              </div>
