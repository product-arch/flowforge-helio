            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="smsServiceName">Service Name</Label>
                    <Input
                      id="smsServiceName"
                      value={formData.smsServiceName || ''}
                      onChange={(e) => setFormData({ ...formData, smsServiceName: e.target.value })}
                      placeholder="SMS Service Name"
                      className="nodrag"
                    />
                  </div>
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData({ ...formData, templateNamespace: e.target.value })}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="messageType">Message Type</Label>
                    <Select
                      value={formData.messageType || 'promotional'}
                      onValueChange={(value) => setFormData({ ...formData, messageType: value })}
                    >
                      <SelectTrigger className="nodrag">
                        <SelectValue />
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="emailMessageType">Message Type</Label>
                    <Select
                      value={formData.emailMessageType || 'transactional'}
                      onValueChange={(value) => setFormData({ ...formData, emailMessageType: value })}
                    >
                      <SelectTrigger className="nodrag">
                        <SelectValue />
                      </SelectTrigger>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-2">
                      ...
                      />
                      <Label className="text-sm">Track opens and clicks</Label>
                    </div>
                  </div>
                  <div>
                    <Label htmlFor="priority">Priority Level</Label>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="voiceServiceName">Service Name</Label>
                    <Input
                      id="voiceServiceName"
                      value={formData.voiceServiceName || ''}
                      onChange={(e) => setFormData({ ...formData, voiceServiceName: e.target.value })}
                      placeholder="Voice Service Name"
                      className="nodrag"
                    />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="voiceMessageType">Message Type</Label>
                    <Select
                      value={formData.voiceMessageType || 'promotional'}
                      onValueChange={(value) => setFormData({ ...formData, voiceMessageType: value })}
                    >
                      <SelectTrigger className="nodrag">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        ...
                        <SelectItem value="alerts">Alerts & Reminders</SelectItem>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="callDuration">Max Call Duration (seconds)</Label>
                    <Input
                      id="callDuration"
                      type="number"
                      value={formData.callDuration || 60}
                      onChange={(e) => setFormData({ ...formData, callDuration: parseInt(e.target.value) })}
                      min="10"
                      max="300"
                      className="nodrag"
                    />
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="rcsBotName">Bot Name</Label>
                    <Input
                      id="rcsBotName"
                      value={formData.rcsBotName || ''}
                      onChange={(e) => setFormData({ ...formData, rcsBotName: e.target.value })}
                      placeholder="Your RCS Bot Name"
                      className="nodrag"
                    />
                  </div>
                  <div>
                    <Label htmlFor="rcsAgentId">RCS Agent ID</Label>
                    <Input
                      id="rcsAgentId"
                      value={formData.rcsAgentId || ''}
                      onChange={(e) => setFormData({ ...formData, rcsAgentId: e.target.value })}
                      placeholder="Your RCS Agent ID"
                      className="nodrag"
                    />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="rcsBrandId">Brand ID</Label>
                    <Input
                      id="rcsBrandId"
                      value={formData.rcsBrandId || ''}
                      onChange={(e) => setFormData({ ...formData, rcsBrandId: e.target.value })}
                      placeholder="Your Brand ID"
                      className="nodrag"
                    />
                  </div>
                  <div>
                    <Label htmlFor="rcsMessageType">Message Type</Label>
                    <Select
                      value={formData.rcsMessageType || 'promotional'}
                      onValueChange={(value) => setFormData({ ...formData, rcsMessageType: value })}
                    >
                      <SelectTrigger className="nodrag">
                        <SelectValue />
                      </SelectTrigger>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="richCardEnabled">Enable Rich Cards</Label>
                    <div className="flex items-center space-x-2 mt-2">
                      <Switch
                        checked={formData.richCardEnabled !== false}
                        onCheckedChange={(checked) => setFormData({ ...formData, richCardEnabled: checked })}
                      />
                      <Label className="text-sm">Support rich media content</Label>
                    </div>
                  </div>
                  <div>
                    <Label htmlFor="suggestedReplies">Enable Suggested Replies</Label>
                    <div className="flex items-center space-x-2 mt-2">
                      <Switch
                        checked={formData.suggestedReplies !== false}
                        onCheckedChange={(checked) => setFormData({ ...formData, suggestedReplies: checked })}
                      />
                      <Label className="text-sm">Show suggested reply buttons</Label>
                    </div>
                  </div>
                </div>
              </CardContent>
