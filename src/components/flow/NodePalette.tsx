...
const nodeTypes: NodeType[] = [
  ...
  // Routing Nodes
  {
    ...
    icon: DollarSign,
    color: 'text-primary',
    description: 'Route to cheapest available vendor',
    category: 'Routing',
  },
  {
    id: 'weightedsplit',
    ...
    icon: Percent,
    color: 'text-primary',
    description: 'Distribute traffic by percentage weights',
    category: 'Routing',
  },
  {
    id: 'fallback',
    ...
    icon: RotateCcw,
    color: 'text-primary',
    description: 'Backup routing when primary fails',
    category: 'Routing',
  },
  {
    id: 'priorityroute',
    ...
    icon: ArrowUpDown,
    color: 'text-primary',
    description: 'Route based on vendor priority levels',
    category: 'Routing',
  },
  {
    id: 'spillover',
    ...
    icon: TrendingDown,
    color: 'text-primary',
    description: 'Overflow to secondary vendors at capacity',
    category: 'Routing',
  },
  {
    id: 'roundrobin',
    ...
    icon: RotateCcw,
    color: 'text-primary',
    description: 'Distribute evenly across vendors',
    category: 'Routing',
  },
  {
    id: 'geolocation',
  ...
  },
  {
    ...
    icon: Gauge,
    color: 'text-primary',
    description: 'Advanced load balancing algorithms',
    category: 'Routing',
  },
