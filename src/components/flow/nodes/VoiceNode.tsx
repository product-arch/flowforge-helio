  ...
  return (
    <TooltipProvider>
      <div className={`
        ...
        ${selected ? 'border-primary' : 'border-node-voice'}
      ...
      `}>
        ...
        <div className="flex items-center gap-2 mb-3">
          <div className="p-2 bg-node-voice/10 rounded-lg">
            <Phone className="w-4 h-4 text-node-voice" />
          </div>
          <div className="flex-1 min-w-0">
            <h3 className="font-semibold text-sm truncate">Voice</h3>
        ...
        <div className="space-y-2 mb-3">
          ...
          <div className="bg-accent/30 rounded p-2">
            <div className="flex items-center gap-2">
              <Phone className="w-3 h-3 text-node-voice" />
        ...
        <Handle
          ...
          className="w-3 h-3 bg-node-voice border-2 border-background"
        />
        <Handle
          type="source"
