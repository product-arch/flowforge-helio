...
const modules = [
  {
    ...
    title: "Routing",
    description:
      "Build intelligent message routing flows with multi-vendor support and fallback mechanisms",
    icon: GitBranch,
  ...
  },
  {
    ...
    title: "Vendors",
    description:
      "Manage vendor relationships, onboarding, and health monitoring for all channels",
    icon: Store,
...
const Home: React.FC = () => {
  ...
  const [cookiePreferencesOpen, setCookiePreferencesOpen] =
    React.useState(false);
  ...
  const handleThemeChange = (newTheme: Theme) => {
    ...
    toast({
      ...
      description: `Switched to ${
        themes.find((t) => t.value === newTheme)?.label
      }`,
      className:
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="text-xl font-body text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
            Create intelligent communication workflows with multi-vendor
            routing, real-time analytics, and seamless integrations. Start
            building in minutes.
          </p>
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-lg font-body text-muted-foreground max-w-2xl mx-auto">
              Choose a module to get started. Each module is designed to work
              seamlessly together for a complete communication automation
              platform.
            </p>
          </div>
          ...
          <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
            <CardContent className="p-8">
              ...
              <p className="font-body text-muted-foreground mb-6 max-w-2xl mx-auto">
                Jump straight into building your first routing flow, or explore
                our other modules to see how Hub can transform your
          ...
          <div className="container mx-auto px-6 py-6">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="text-sm text-muted-foreground">
                © {new Date().getFullYear()} Helo.ai by VivaConnect. All rights
                reserved.
              </div>
      ...
      {/* Footer Modals */}
      <PrivacyPolicyModal
        isOpen={footerPrivacyOpen}
        onClose={() => setFooterPrivacyOpen(false)}
      />
      <TermsOfServiceModal
        isOpen={footerTermsOpen}
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                <p>
                  <strong className="text-foreground">Hub</strong> is an
                  intelligent communication routing platform that enables
                  businesses to build sophisticated messaging workflows with
                  multi-vendor support, real-time analytics, and seamless
                  integrations.
                </p>
                <p>
                  Our platform empowers teams to create, manage, and optimize
                  communication flows across SMS, WhatsApp, Email, Voice, and
                  RCS channels with advanced routing logic and fallback
                  mechanisms.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                <p>
                  <strong className="text-foreground">Helo.ai</strong> is a
                  leading provider of AI-powered communication solutions,
                  helping businesses automate and optimize their customer
                  engagement across multiple channels.
                </p>
                <p>
                  Founded in 2001, Helo.ai serves over 500+ enterprises
                  globally, processing millions of messages daily with
                  industry-leading delivery rates and cost optimization.
                </p>
                <p>
                  <strong className="text-foreground">Mission:</strong> To
                  democratize intelligent communication automation and make
                  enterprise-grade messaging accessible to businesses of all
                  sizes.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="text-xs text-muted-foreground pt-2 border-t border-border">
                  <p>
                    © {new Date().getFullYear()} Helo.ai. All rights reserved.
                  </p>
